...
function download(t) {
    if (t == "check") {
        ...
        let body = "儲存你的專案<br>選擇一種方法:<p></p><div class='flex'><div class='radio'><label><input type='radio' id='dl-file-1' name='dl-radio'><span class='round button'><center>輸出帶資料的URL</center></span></label></div> <div class='radio'><label><input type='radio' id='dl-file-2' checked name='dl-radio'><span class='round button'><center>直接下載</center></span></label></div></div><p><strong>帶資料的URL:</strong>將你的編輯內容儲存在連結中，將連結另存或加入書籤來保存變更<br /><strong>直接下載:</strong>將你的編輯內容輸出成檔案並下載</p>"
